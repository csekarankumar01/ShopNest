...
const About = () => {
  ...
  return (
    <div style={containerStyle}>
      <img
        src="https://github.com/csekarankumar01.png"
        alt="Karan Kumar"
      ...
      <h3 style={{ fontSize: '1.5rem', color: '#f97316', marginBottom: '15px' }}>Karan Kumar</h3>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '10px', marginTop: '20px' }}>
        <a href="https://github.com/csekarankumar01" target="_blank" rel="noreferrer" style={socialBtnStyle}>🐙 GitHub</a>
        <a href="https://kumar-karan.vercel.app/" target="_blank" rel="noreferrer" style={{ ...socialBtnStyle, background: 'rgba(59, 130, 246, 0.2)', borderColor: '#3b82f6', color: '#3b82f6' }}>💼 Portfolio</a>
      </div>
    </div>
  );
};
